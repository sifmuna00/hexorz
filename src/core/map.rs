...
impl HexMap {
    ...
    pub const PREMADE_MAP_0: [[char; 9]; 9] = [
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', 'A', '*', '*', '*', '*', '.', '.', '.'],
        ['.', '.', '*', '*', 'X', '*', '.', '.', '.'],
    ...
    pub const PREMADE_MAP_1: [[char; 9]; 9] = [
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', 'A', '*', '.', '.', '.', '.', '.', '.'],
        ['.', '*', '*', '.', '.', '.', '.', '.', '.'],
    ...
    pub const PREMADE_MAP_2: [[char; 9]; 9] = [
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', 'A', '*', '.', '.', '.', '.', '.', '.'],
        ['.', '*', '*', '.', '.', '.', '.', '.', '.'],
        ['.', '*', '*', '*', '*', '.', '.', '.', '.'],
    ...
    pub const PREMADE_MAP_3: [[char; 9]; 9] = [
        ['.', '.', '.', '.', '.', '.', '.', '.', '.'],
        ['.', '.', '.', '.', '*', '*', '*', '*', '.'],
        ['.', '.', 'A', '*', '.', '.', '*', '*', '.'],
        ['.', '.', '*', '*', '.', '.', '*', '*', '.'],
...
pub fn load_map(arr: [[char; 9]; 9]) -> HexMap {
    let mut hexmap = HashMap::new();
